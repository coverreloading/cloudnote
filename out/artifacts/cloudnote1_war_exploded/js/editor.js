...
(function ($) {
    ...
    var methods = {
        ...
        restoreIESelection: function () {
            ...
            var range = $(this).data('currentRange');
            if (range) {
                if (window.getSelectiongetSelection) {
                    sel = window.getSelection();
                    sel.removeAllRanges();
                    sel.addRange(range);
                } else if (document.selection && range.select) {
        ...
        imageWidget: function () {
            // Class for Widget Handling the upload of Files 上传文件的工具类
            var row = $('<div/>', {
                "class": "row"
            }).append($('<div/>', {
                id: "imgErrMsg"
        ...
        tableWidget: function (mode) {
            // Function to generate the table input form 输入框函数
            var idExtn = '';
        ...
        getHTMLTable: function (tblRows, tblColumns, attributes) {
            // Function to generate html table. Supplied arguments: 用来生成html表的函数
