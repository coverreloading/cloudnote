    ...
    <c:if test="${not empty user}">
        <form action="${pageContext.request.contextPath}/userUpdateServlet" method="post">
            ...
            <div class="form-group">
                <label>用户名</label>
                <input type="text" class="form-control" id="user-name" name="userName" placeholder="${user.userName}">
            </div>
            <div class="form-group">
                <label>邮箱</label>
                    <%--${requestScope["user"]}--%>
            ...
            <div class="form-group">
                <label>年龄</label>
                <input type="text" class="form-control" id="age" name="age" placeholder="${user.age}"onchange="updateCheck()">
            </div>
            <div class="form-group">
                <label>性别</label><br>
            ...
            <div class="form-group">
                <label>手机</label>
                <input type="text" class="form-control" id="phone" name="phone" placeholder="${user.phone} "onchange="updateCheck()">
            </div>
